...
class Banner extends Component{
    state= {
        ...
        columns:[
          ...
          },
          {
             ...
             render(path){
                 return(
                     <img src={path} width="200" height="100"></img>
                 )
             }
          },
          {
    ...
    handleOk=async()=>{
        ...
        if(code == 0){message.success('修改成功',1,()=>{
            this.renderBanner()     
        })
    ...
    let {_id,title,src} = this.state
       let {code,data} = await apiBanner.findOneBanner(payload._id)
         _id = data[0]._id
         title = data[0].title
         src = data[0].imgsrc
    ...
    render(){
        ...
        >
         ...
         <img src={src} width="80%" height="100" ref="imgsrc"></img><br/><br/>
